...
class Resize(Frame):
    ...
    def button_click(self):
        ...
        def send_mail_function():  # Send email alert
            recipientmails = ["Abhishekkamboj2121@gmail.com"]  
            location = "Chandigarh University, Building A, Floor 1, Room 48"
...
[xyz]
            ...
            msg = MIMEText(body)
            msg['Subject'] = subject
            msg['From'] = "aravindkumar2107@gmail.com"  # Sender's email address
            ...
            try:
                ...
                server.ehlo()
                server.starttls()
                server.login("aravindkumar2107@gmail.com", 'hrijtkqzxkcwsjul')  # Sender's email login
